...
<script type="text/javascript">
	function open_win() 
	{
	window.open('${pageContext.request.contextPath}/CustomerAction_list?select=true','','width=600,height=400')
	}
</script>
</HEAD>
<BODY>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								...
								<input type="text" id="cust_name" name="customer.cust_name" style="WIDTH: 180px" />
								<input type="button" value="选择" onclick="open_win()"/>
								</td>
							</tr>
							<TR>
								<td>联系人名称：</td>
