										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:property value="#list.customer.cust_name" /></TD>
													<TD><s:property value="#list.visit_time" /></TD>
													<TD><s:property value="#list.visit_interviewee" /></TD>
													<TD><s:property value="#list.visit_addr" /></TD>
													<TD><s:property value="#list.visit_detail" /></TD>
													<TD><s:property value="#list.visit_nexttime" /></TD>
													<TD>
															<!-- 没有传递参数,显示删除和修改操作 -->
